...
Coords Coords::aleatoire(double amplitude, std::mt19937& Seed)
{
    return { util::alea(-amplitude, amplitude, Seed),
             util::alea(-amplitude, amplitude, Seed) };
}

void Coords::muter(double amplitude, std::mt19937& Seed)
{
    m_x = m_x + util::alea(-amplitude, amplitude, Seed);
    m_y = m_y + util::alea(-amplitude, amplitude, Seed);
}
